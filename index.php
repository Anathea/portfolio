...
<!--                <h3>Et je postule pour l'agence avignonaise Vertuoz !</h3>-->
            ...
            <section>
                <aside>
                    ...
                    <ul>
                        ...
                        <li><h4>Étudiante à <a href="https://www.hetic.net/formations/bachelor-web" title="HÉTIC, Bachelor Web (nouvel onglet)" target="_blank" rel="noopener noreferrer" class="hetic"><img alt="logo HETIC" src="img-content/logo_hetic.png"> HÉTIC</a></h4><p> (mais made in Avignon !)</p></li>
                ...
                <div class='projets'>
                    <a href="https://github.com/Anathea" rel="noopener noreferrer" title="Mon profil Github (nouvel onglet)" target="_blank"><img alt="Git" src="img-content/git.png" class="icon"></a>
            ...
            <footer>
                <div class="cluster">
                    ...
                    <div class="links">
                        <ul>
                            <li><a href="https://www.facebook.com/people/Sol%C3%A8ne-Fernandez-Serrano/100011344283484" title="Profil Facebook : Solène Fernandez Serrano (nouvel onglet)" target="_blank" rel="noopener noreferrer"><img alt="Facebook" src="img-content/facebook.svg"></a></li>
